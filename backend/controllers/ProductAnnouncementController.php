...
class ProductAnnouncementController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $dataProviderActive->query->andWhere(['"product".type' => Product::TYPE_ANNOUNCE]);
    ...
    public function actionActive($id)
    {
        ...
        if ($model->save(false)) {
            ...
            return $this->redirect(['/product-announcement']);
        } else {
    ...
    public function actionDeactive($id)
    {
        ...
        if (!$product) return $this->redirect('/product-announcement');
