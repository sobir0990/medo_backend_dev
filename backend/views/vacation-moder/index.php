...
$this->title = Yii::t('main', 'Лента модератора Вакансия');
...
$this->registerJs(
  ...
  $('#moderlistfrom-vacation_id').val($(this).data('id'));
  var act =  '/vacation-moder/deactive/'+ $(this).data('id');
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php
                $model = new \backend\models\VacationListFrom();
                $form = ActiveForm::begin([
                    'action' => '/vacation-moder/deactive/'
                ]); ?>
                ...
                <div class="tab-content">
                        ...
                        <div class="tab-pane" id="content_02">
                            ...
                            <input type="hidden" id="moderlistfrom-vacation_id" class="form-control" name="VacationListFrom[vacation_id]">
