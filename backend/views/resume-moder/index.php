...
$this->registerJs(
  ...
  $('#moderlistfrom-resume_id').val($(this).data('id'));
  var act =  '/resume-moder/deactive/'+ $(this).data('id');
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php
                $model = new \backend\models\ResumeListFrom();
                $form = ActiveForm::begin([
                    'action' => '/resume-moder/deactive/'
                ]); ?>
                ...
                <div class="tab-content">
                        ...
                        <div class="tab-pane" id="content_02">
                            ...
                            <input type="hidden" id="moderlistfrom-resume_id" class="form-control" name="ResumeListFrom[resume_id]">
