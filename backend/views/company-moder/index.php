...
$this->registerJs(
  ...
  $('#moderlistfrom-company_id').val($(this).data('id'));
  var act =  '/company-moder/deactive/'+ $(this).data('id');
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php
                $model = new \backend\models\CompanyListFrom();
                $form = ActiveForm::begin([
                    'action' => '/company-moder/deactive/'
                ]); ?>
                ...
                <div class="tab-content">
                        ...
                        <div class="tab-pane" id="content_02">
                            ...
                            <input type="hidden" id="moderlistfrom-company_id" class="form-control" name="CompanyListFrom[company_id]">
