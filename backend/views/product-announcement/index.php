...
$this->title = Yii::t('main', 'Лента модератора Компания');
...
$this->registerJs(
  ...
  $('#moderlistfrom-product_id').val($(this).data('id'));
  var act =  '/product-announcement/deactive/'+ $(this).data('id');
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php
                $model = new \backend\models\ProductListFrom();
                $form = ActiveForm::begin([
                    'action' => '/product-announcement/deactive/'
                ]); ?>
                ...
                <div class="tab-content">
                        ...
                        <div class="tab-pane" id="content_02">
                            ...
                            <input type="hidden" id="moderlistfrom-product_id" class="form-control" name="ProductListFrom[product_id]">
