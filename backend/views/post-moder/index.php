...
$this->title = Yii::t('main', 'Лента модератора Посты');
...
$this->registerJs(
  ...
  $('#moderlistfrom-post_id').val($(this).data('id'));
  var act =  '/post-moder/deactive/'+ $(this).data('id');
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php
                $model = new \backend\models\PostListFrom();
                $form = ActiveForm::begin([
                    'action' => '/post-moder/deactive/'
                ]); ?>
                ...
                <div class="tab-content">
                        ...
                        <div class="tab-pane" id="content_02">
                            ...
                            <input type="hidden" id="moderlistfrom-post_id" class="form-control" name="PostListFrom[post_id]">
